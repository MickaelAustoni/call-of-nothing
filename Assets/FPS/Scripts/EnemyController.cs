...
public class EnemyController : MonoBehaviour
{
    ...
    [Header("Parameters")] [Tooltip("The weapon this enemy uses for attacking")]
        ...
        foreach (Actor actor in m_ActorsManager.actors)
        {
            if (actor.affiliation != m_Actor.affiliation)
            {
                ...
                if (sqrDistance < sqrDetectionRange && sqrDistance < closestSqrDistance)
                {
                    ...
                    RaycastHit[] hits = Physics.RaycastAll(detectionSourcePoint.position, (actor.aimPoint.position - detectionSourcePoint.position).normalized, detectionRange, -1,
